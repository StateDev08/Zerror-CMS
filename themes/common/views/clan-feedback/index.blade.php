...
@section('title', __('nav.clan_feedback') . ' - ' . site_name())
...
@section('content')
    ...
    <form action="{{ route('clan-feedback.store') }}" method="POST" class="card space-y-5 max-w-lg">
        ...
        <div>
            <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5">{{ __('clan.feedback_message') }}</label>
