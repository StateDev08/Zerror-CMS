...
<div id="nav-menu" class="block">
    <ul class="flex flex-col gap-1">
        ...
        <li>
            <details class="group/details">
                ...
                <ul class="mt-1 ml-2 pl-3 border-l-2 border-neutral-200 dark:border-neutral-600 {{ $dropdownBg }} rounded-r-xl space-y-0.5 py-2">
                    ...
                    <li><a href="{{ route('clan-treasury.index') }}" class="block py-2 px-3 rounded-lg {{ $dropdownHover }} {{ $linkClass }} text-sm transition-colors">{{ __('nav.clan_treasury') }}</a></li>
        ...
        @else
            ...
            <li><a href="{{ url('/admin') }}" target="_blank" rel="noopener noreferrer" class="block py-2.5 px-3 rounded-xl {{ $linkClass }} font-semibold transition-colors">{{ __('nav.admin') }}</a></li>
            <li>
